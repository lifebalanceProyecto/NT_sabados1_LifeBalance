...
from notebook.consumo_recomendaciones import consumir_recomendaciones
...
def transformar_recomendaciones(numero_recomendaciones: int = 50, use_api: bool = True, api_url: Optional[str] = None, timeout: int = 5) -> pd.DataFrame:
    ...
    """
    data_frame = consumir_recomendaciones(numero_recomendaciones, use_api=use_api, api_url=api_url, timeout=timeout)
