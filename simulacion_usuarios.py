...
def simular_usuarios(numeroUsuarios):
    ...
    fechaInicial = datetime(2025, 1, 1)  # ✅ paréntesis, no corchetes
    ...
    for _ in range(numeroUsuarios):
        ...
        if probabilidadError < 0.1:
            ...
            usuario["correo"] = random.choice(["sin_arroba.com", "correo@.com", "correo@gmail", "", None])
        elif probabilidadError < 0.3:
            usuario["contrasena"] = random.choice(["123", "abc", "", None])
        elif probabilidadError < 0.4:
            usuario["sexo"] = random.choice(["otro", "desconocido", "", None])
